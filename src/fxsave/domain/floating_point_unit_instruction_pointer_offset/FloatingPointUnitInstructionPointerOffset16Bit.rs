...
#[repr(C)]
pub struct FloatingPointUnitInstructionPointerOffset16Bit
{
	/// x87 FPU Instruction Pointer Offset, `FIP`.
	pub instruction_pointer_offset: u16,
...
impl PartialEq for FloatingPointUnitInstructionPointerOffset16Bit
{
	#[inline(always)]
...
impl Eq for FloatingPointUnitInstructionPointerOffset16Bit
{
}

impl PartialOrd for FloatingPointUnitInstructionPointerOffset16Bit
{
	#[inline(always)]
...
impl Ord for FloatingPointUnitInstructionPointerOffset16Bit
{
	#[inline(always)]
...
impl Hash for FloatingPointUnitInstructionPointerOffset16Bit
{
	#[inline(always)]
